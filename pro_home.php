        ...
        <div class="container"> 
          <div class="row">
            ...
            <div class="col-lg-6 content">
              <h4>Welcome to Agri Vehicle Provier</h4>
			  ...
			  <div class="row">
				...
				<div class="col-md-6">
				<?php echo $r1['address'];?>, <?php echo $r1['district'];?>
				</div>
			  </div>
			  <br>
			  <div class="row">
				...
				<div class="col-md-6">
				<?php echo $r1['mobile'];?>, <?php echo $r1['email'];?>
				</div>
			  </div>
			  <br>
			 <div class="row">
				...
				<div class="col-md-6">
				<?php echo $r1['create_date'];?>
				</div>
			  </div>
			  <br>
			  
			  <a href="pro_add.php">Add Agri Vehicles</a>
