...
if(isset($register))
{
	 $q1=mysqli_query($connect,"select * from ar_provider where email='$email' || uname='$uname'");
	 $n1=mysqli_num_rows($q1);
	 if($n1==0)
	 {
	$mq=mysqli_query($connect,"select max(id) from ar_provider");
	$mr=mysqli_fetch_array($mq);
	$id=$mr['max(id)']+1;
    $ins=mysqli_query($connect,"insert into ar_provider(id,name,address,district,mobile,email,uname,pass,create_date,status,lat,lon) values($id,'$name','$address','$district','$mobile','$email','$uname','$pass','$rdate','0','$lat','$lon')");
			if($ins)
			{
		 ?>
...
<!--     <label for="longitude">Longitude:</label>
 -->    <input type="hidden" id="longitude" name="lon">
    ...
    <br><br>
				...
				<div class="col-md-6">
				<input type="submit" name="register" class="btn" value="Register" onClick="return validate()">
				</div>
			  </div>
