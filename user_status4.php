...
<main id="main">
	  ...
	  <section id="services">
        <div class="container">
          ...
          <div class="row">
          <?php
                                        $q2 = mysqli_query($connect, "SELECT * FROM ar_products v,ar_fertilizer_booking b where v.id=b.pid and b.uname='$uname' order by b.id desc");
              ...
              <div class="col-lg-4">
                <div class="box wow  fadeInLeft">
				  ...
				  <p> Provider: <?php echo $r1['provider'];?></p>
