...
$q2 = mysqli_query($connect, "SELECT * FROM ar_products where id='$id'");
...
if (move_uploaded_file($_FILES["file"]["tmp_name"], $file)) {
 ...
 $ins=mysqli_query($connect,"update ar_products set details='$details', quantity='$quantity', price='$price', photo='$file' where id='$id'"); 
			if($ins)
			{
		 ?>
...
<body id="body"> 
 ...
 <section id="innerBanner"> 
  <div class="inner-content">
    <h2><span>Farmer</span><br><?php echo $uname;?></h2>
    <div> 
    </div>
  </div> 
</section><!-- #Page Banner -->
      ...
      <section id="about" class="wow fadeInUp">
        <div class="container"> 
          <div class="row">
            ...
            <div class="col-lg-6 content">
              <h4>Edit Agri Products/fertilizer</h4>
			 <!--  {% if msg=="success" %}
			  <script language="javascript">
			  alert("Added.");
        ...
        <span style="color:#FF0000"><?php echo $msg;?></span>
			  ...
			  <div class="row">
				...
				<div class="col-md-6">
				<input type="text" name="pname" class="form-control" value="<?php echo $r1['pname'];?>" placeholder="" required>
				</div>
			  </div>
			  <br>
			  <div class="row">
				...
				<div class="col-md-6">
                    <select name="ptype" id="">
                        <option value="<?php echo $r1['ptype'];?>"><?php echo $r1['ptype'];?></option>
                    </select>
				</div>
			  </div>
			  <br>
