...
$q1=mysqli_query($connect,"select * from ar_vehicle where pname='$fname' and shopname='$username'");
	 $n1=mysqli_num_rows($q1);
	 if($n1==0)
	 {
    $mq=mysqli_query($connect,"select max(id) from ar_vehicle");
	$mr=mysqli_fetch_array($mq);
	$id=$mr['max(id)']+1;
 $ins=mysqli_query($connect,"insert into ar_vehicle(id,uname,vehicle,vno,details,cost1,cost2,photo,create_date,status) values($id,'$uname','$vehicle','$vno','$details','$cost1','$cost2','$file','$rdate','0')");
			if($ins)
			{
		 ?>
	<script language="javascript">
		alert("Vechicle Added");
      ...
      <section id="about" class="wow fadeInUp">
        ...
        <span style="color:#FF0000"><?php echo $msg;?></span>
			  ...
			  <div class="row">
				...
				<div class="col-md-6">
				<input type="text" name="vehicle" class="form-control" placeholder="" required>
				</div>
			  </div>
			  <br>
			  <div class="row">
				...
				<div class="col-md-6">
				<input type="text" name="vno" class="form-control" placeholder="" required>
				</div>
			  </div>
			  <br>
			  <div class="row">
			  ...
			  <div class="row">
				...
				<div class="col-md-6">
				<input type="text" name="cost1" class="form-control" placeholder="" required>
				</div>
			  </div>
			  <br>
			  <div class="row">
				...
				<div class="col-md-6">
				<input type="text" name="cost2" class="form-control" placeholder="" required>
				</div>
			  </div>
