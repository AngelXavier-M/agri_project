...
<body id="body"> 
 ...
 <section id="innerBanner"> 
  <div class="inner-content">
    <h2><span>Administrator</span><br>We provide high quality vehicles</h2>
    <div> 
    </div>
  </div> 
</section><!-- #Page Banner -->
        ...
        <div class="container"> 
          <div class="row">
            ...
            <div class="col-lg-12 content">
              <h4>Agri Vehicle Provider - Information</h4>
			 <!--  {% if msg=="success" %}
			  ...
			  <div class="row">
        <?php
                                        $q2 = mysqli_query($connect, "SELECT * FROM ar_provider");
			  ...
			  <td><?php echo $i;?>. Vehicle Provider: <?php echo $r1['name'];?></td>
			  </tr>
			  <tr>
			  <td>Address: <?php echo $r1['address'];?>, <?php echo $r1['district'];?></td>
			  </tr>
			  <tr>
			  <td>Contact: <?php echo $r1['mobile'];?>, <?php echo $r1['email'];?></td>
			  </tr>
			  <tr>
			  <td>
			  <a href="view_pro.php?user=<?php echo $r1['uname'];?>">Vehicle Info</a> /
        <?php
        if($r1['status']==1){
          echo "Approved";
          ...
          ?>
          			  <a href="admin.php?act=ok&pid=<?php echo $r1['id'];?>">Click to Approve</a>
                  <?php
...
if ($act == "ok") {
    mysqli_query($connect, "UPDATE ar_provider SET status='1' WHERE id='$pid'");
