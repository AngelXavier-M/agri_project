...
if (isset($_POST['btn11'])) {
  ...
  $ins = mysqli_query($connect, "UPDATE ar_fertilizer_booking SET status='2' WHERE id='$payid'");
  if ($ins) {
      ?>
      <script language="javascript">
          alert("<?php echo $uname; ?>, Money Paid!");
          window.location.href = "user_status4.php";
      </script>
      <?php
  } else {
      $msg = "Payment Failed!";
          ...
          <div class="section-header">
		   ...
		   <div class="row">
			...
			<div class="row">
				...
				<div class="col-md-4">
          <?php
        $q2 = mysqli_query($connect, "SELECT * FROM ar_fertilizer_booking where id='$payid'");
