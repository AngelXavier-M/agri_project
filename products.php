...
<main id="main">
	  ...
	  <section id="services">
        <div class="container">
          ...
          <div class="row">
          <?php
                                        $q2 = mysqli_query($connect, "SELECT * FROM ar_products where uname='$uname'");
                ...
                <div class="box wow  fadeInLeft">
                  <div class="car-info-box">
                    ...
                    <div class="inventory_info_m ">
                      <p>
                        <a href="edit.php?id=<?php echo $r1['id'];?>">Edit</a> |
                        <a href="products.php?act=del&id=<?php echo $r1['id'];?>">Delete</a>
                      </p>
                    </div>
                  </div>
                </div>
...
if ($act == "del") {
    mysqli_query($connect, "DELETE FROM ar_products WHERE id='$id'");
    ?>
