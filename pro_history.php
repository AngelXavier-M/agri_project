	  ...
	  <section id="services">
        <div class="container">
          ...
          <?php
                                        ...
                                        SELECT *
FROM ar_vehicle v
JOIN ar_booking b ON v.id = b.vid
WHERE b.provider = '$uname' AND b.status = '2'
ORDER BY b.id DESC;
");
                ...
                <div class="box wow  fadeInLeft">
				  ...
				  <p>USer: <?php echo $r1['uname'];?></p>
					...
					<p>Specification: <?php echo $r1['details'];?></p>
                      ...
                      <p>
                      Duration: <?php echo $r1['time_type'];?>
            <?php
            if($r1['time_type']==1){
              echo "Hours";
            }
            ...
            ?>
					...
					<p>
					  ...
					  Vehicle Returned
					  <br>Amount Paid (Rs. <?php echo $r1['amount'];?>)
