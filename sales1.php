...
<main id="main">
	  ...
	  <section id="services">
        <div class="container">
          ...
          <div class="row">
          <?php
                                        $q2 = mysqli_query($connect, "SELECT * FROM ar_products v,ar_fertilizer_booking b where v.id=b.pid and b.provider='$uname' order by b.id desc");
            ...
            if($r1['status']==2){
              ...
              echo "amount Paid";
              ?>
              <a href="sales1.php?act=s&payid=<?php echo $r1['id'];?>">Delivery</a>
            <?php
            }
            else if($r1['status']==3){
...
if ($act == "s") {
    mysqli_query($connect, "update ar_fertilizer_booking set status='3' WHERE id='$payid'");
    ?>
