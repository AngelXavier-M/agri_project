...
if(isset($btn))
	{
		$q1=mysqli_query($connect,"select * from ar_provider where uname='$uname' && pass='$pass' && status='1'");
			$n1=mysqli_num_rows($q1);
                ...
                <script language="javascript">
                    alert("Logged In");
                    window.location.href="pro_home.php";
                </script>
                <?php
				}
				else
 ...
 <header id="header">
  ...
  <nav id="nav-menu-container">
    <ul class="nav-menu">
      ...
      <li><a href="/login_pro">Provider</a></li>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 content">
			  ...
			  <div class="row">
				...
				<a href="reg_pro.php">Register here</a>			  
