...
<li>
    ...
    <ul>
        ...
        <li><a href="user_status2.php">My Booking</a></li>
    </ul>
</li>
...
<main id="main">
	  ...
	  <section id="services">
        <div class="container">
          ...
          <div class="row">
          <?php
                                        $q2 = mysqli_query($connect, "SELECT * FROM ar_products v,ar_product_booking b where v.id=b.pid and b.uname='$uname' order by b.id desc");
