...
<form name="form1" method="post">
          ...
          <br>
				<input type="text" name="card" maxlength="12" class="form-control" placeholder="Card No." required> <br>
				<input type="text" name="expiry" class="form-control" placeholder="Expiry Date" required> <br>
				<input type="text" name="CVv" maxlength="12" class="form-control" placeholder="CVV" required> <br>
				<input type="text" name="Pin" maxlength="12" class="form-control" placeholder="PIN" required> <br>
				</div>
			</div>
			<br>
			<div class="row">
