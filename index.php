...
{
	 $q1=mysqli_query($connect,"select * from ar_user where email='$email' || uname='$uname'");
	 $n1=mysqli_num_rows($q1);
	 if($n1==0)
	 {
	$mq=mysqli_query($connect,"select max(id) from ar_user");
	$mr=mysqli_fetch_array($mq);
	$id=$mr['max(id)']+1;
    $ins=mysqli_query($connect,"insert into ar_user(id,name,address,district,mobile,email,uname,pass,rdate) values($id,'$name','$address','$district','$mobile','$email','$uname','$pass','$rdate')");
			if($ins)
			{
		 ?>
...
if(isset($login))
	{
		$q1=mysqli_query($connect,"select * from ar_user where uname='$uname' && pass='$pass' ");
			$n1=mysqli_num_rows($q1);
				if($n1==1)
				{
...
<head>
  <meta charset="utf-8">
  <title>Agriculture Vehicle Rental</title>
...
<body id="body">
  ...
  <nav id="nav-menu-container">
    <ul class="nav-menu">
      ...
      <li><a href="login_pro.php">Provider</a></li>
      ...
      <div class="container">
        ...
        <div class="hero-content">
          <div>
              ...
              <a href="#loginform" data-toggle="modal" data-dismiss="modal" class="btn-banner">Farmer Login / Register</a> 
      ...
      <section id="services">
        <div class="container">
          <div class="section-header">
            <h2>Find the Agri Vehicle for you</h2>
            <p>Agricultural Vehicle is a vehicle or truck-tractor trailer are provide for rental to Farmers for farming business and used exclusively in agricultural operations to transport agricultural products.</p>
          </div>
          ...
          <div class="row">
              ...
              <div class="col-lg-4">
                <div class="box wow  fadeInLeft">
                  <div class="car-info-box">
                    <a href=""><img src="./static/img/ag1.jpg" style="height: 180px; width: 280px;" class="img-responsive"  alt="image" >
                    </a>
                    <ul style=" width: 280px;">
                      <li><i class="fa fa-car" aria-hidden="true"></i>Tractor</li>
                      <li><i class="fa fa-calendar" aria-hidden="true"></i></li>
                      <li><i class="fa fa-user" aria-hidden="true"></i></li>
                    </ul>
                    <div class="car-title-m">
                      <h6><a href="">Provider</a></h6>
                      <span class="price">Rs. 200 / Day</span> 
                    </div>
			  ...
			  <div class="col-lg-4">
                <div class="box wow  fadeInLeft">
                  <div class="car-info-box">
                    <a href=""><img src="./static/img/ag2.jpg" style="height: 180px; width: 280px;" class="img-responsive"  alt="image" >
                    </a>
                    <ul style=" width: 280px;">
                      <li><i class="fa fa-car" aria-hidden="true"></i>Tractor</li>
                      <li><i class="fa fa-calendar" aria-hidden="true"></i></li>
			  ...
			  <div class="col-lg-4">
                <div class="box wow  fadeInLeft">
                  <div class="car-info-box">
                    <a href=""><img src="./static/img/ag3.jpg" style="height: 180px; width: 280px;" class="img-responsive"  alt="image" >
                    </a>
                    <ul style=" width: 280px;">
                      <li><i class="fa fa-car" aria-hidden="true"></i>Tractor</li>
                      <li><i class="fa fa-calendar" aria-hidden="true"></i></li>
    ...
    <!--==========================
      ...
      <section id="clients" class="wow fadeInUp">
        <div class="container">
          <div class="section-header">
            <h2>Farmers</h2>
            <p>It is a smartest way to track and manage the farm equipment on rent from vehicle providers. Now Farmer can save and earn more through the an agriculture.</p>
          </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-9 text-center text-lg-left">
              ...
              <p class="cta-text">Agricultural Vehicle is a vehicle or truck-tractor trailer are provide for rental to Farmers.</p>
            </div>
          ...
          <div class="signup_wrap">
            <div class="col-md-12 col-sm-6">
              ...
              <form name="form1" method="post">
                ...
                <div class="form-group">
                  <input type="submit" value="Sign Up" name="cusregister" id="submit" class="btn btn-block" style="background-color: #49a3ff;" onClick="return validate()">
                </div>
              </form>
            </div>
