	  ...
	  <section id="services">
        <div class="container">
          <div class="section-header">
            <h2>Vehicle Booking Status</h2>
          
          </div>

          <div class="row">
          <?php
                                        $q2 = mysqli_query($connect, "SELECT * FROM ar_vehicle v,ar_booking b where v.id=b.vid and b.uname='$uname' order by b.id desc");
              ...
              <div class="col-lg-4">
                <div class="box wow  fadeInLeft">
				  ...
				  <p>Vehicle Provider: <?php echo $r1['provider'];?></p>
          ...
          <p>Start Time to End Time - <br>(<?php echo $r1['stime'];?>-<?php echo $r1['etime'];?>)</p>

					<p>
            <?php
            if($r1['status']==1){
              echo "Pay Amount: Rs. " . $r1['amount'];
              ?>
					  <a href="user_pay.php?bid=<?php echo $r1['id'];?>&vid=<?php echo $r1['vid'];?>">Click to Pay & Return Vehicle</a>
            <?php
            }
            elseif($r1['status']==2)
            {
